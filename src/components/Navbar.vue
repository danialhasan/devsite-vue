...
Because of this, the code that is run for those two parent components is different.  -->
    ...
    >
        <div
            id="logo"
            class="xl:hidden font-bold font-sans text-lg dark:text-soft-white xl:mt-12 flex flex-row align-middle"
        >
            <img
        ...
        <div
            id="mobile_menu"
            class="text-soft-white mobile_menu hidden z-50 fixed backdrop-filter backdrop-blur-sm backdrop-brightness-50 top-0 left-0 w-full h-full bg-opacity-10 bg-black text-black-1 dark:text-soft-white"
            @click="toggleMenu()"
        >
        ...
        -->
            ...
            <h2
                class="mt-36 mb-8 font-sans text-5xl font-bold underline text-center"
            >
                Quick Links
            </h2>
            <ul
        ...
        >
            ...
            <div class="flex w-auto h-full">
                <ul
                    class="inline-flex justify-around items-center text-lg font-bold"
                >
