<script>
export default {
  name: "Benford Roofing Case Study",
};
</script>
<template>
  ...
  <div class="w-full h-auto px-6 text-left pt-8">
    <h2 class="font-bold text-xl pb-2">Introduction</h2>
    <p class="text-lg pb-8">
      Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
      doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo
      inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
    </p>
    <h2 class="font-bold text-xl pb-2">Purpose and Goal</h2>
    <p class="text-lg pb-8">
      Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
      doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo
      inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
    </p>
    <h2 class="font-bold text-xl pb-2">Spotlight</h2>
    <p class="text-lg pb-8">
      Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
      doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo
      inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.
