        ...
        return {
            projects: [
                // NOTE: the 'rewriting' and 'building' properties are never both true. They're either opposites or they're both false.
                {
                    ...
                    githubLink:
                        'https://github.com/danialhasan/roofing-company',
                    caseStudy:
                ...
                },
                {
                    ...
                    githubLink:
                        'https://github.com/danialhasan/crypto_address_tracer',
                    caseStudy:
...
<template>
    <div>
        ...
        <div
            id="header"
            class="text-soft-black-background dark:text-soft-white font-bold text-center w-full h-auto mt-20 md:mt-32"
        >
            ...
            <div
                class="w-full h-auto flex flex-col lg:flex-row justify-center mt-12"
            >
        ...
        <div id="skillset" class="w-full h-auto my-44">
            ...
            <div class="w-full max-w-screen-lg mx-auto h-auto px-8">
                <div
                    class="text-gray-800 dark:text-gray-50 text-center md:text-left w-full px-2 my-8 md:mt-12 md:mb-10 md:pl-[22px]"
                >
                    <h1 class="font-bold text-2xl md:text-5xl">
                        Frontend Web Development
                    </h1>
                    <p class="text-lg font-regular mt-3 md:text-2xl">
                        I build web interfaces with Vue &amp; TailwindCSS.
                        Beyond that, I use HTML/CSS and Javascript.
                    </p>
                </div>
                <div
                    id="skillset_container_frontend"
                    class="flex flex-col space-y-4 md:space-y-0 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-4 lg:gap-8"
                >
                    <skillset-component
                ...
                <div
                    class="text-gray-800 dark:text-gray-50 text-center md:text-left w-full px-2 my-8 md:mt-12 md:mb-10 md:pl-[22px] xl:mt-24"
                >
                    <h1 class="font-bold text-2xl md:text-5xl">
